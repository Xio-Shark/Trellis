...
| Command | `agentCapable && hasHooks` (11) | `agentCapable && !hasHooks` (3) | `!agentCapable` (3) |
|---------|--------------------------------|----------------------------------|---------------------|
...
- `agentCapable && hasHooks`: `claude-code, cursor, kiro, gemini, qoder, codebuddy, copilot, droid, pi, trae, zcode`

---
name: break-loop
description: "Deep post-fix bug analysis: root cause, why earlier fixes failed, prevention, blast radius — then write the lesson into .trellis/spec/. Use after a debugging session, after a tricky or recurring bug, or to capture debugging insights into project docs."
---
